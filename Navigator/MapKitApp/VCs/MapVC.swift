...
class MapVC: UIViewController, CLLocationManagerDelegate, UITextFieldDelegate, MKMapViewDelegate
{
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        annotationView?.image = UIImage(named: "img")?.resize(150, 318)
    ...
    private func setupUI() {
        ...
        startLocation.text = "Moscow"
        finishLocation.text = "Samara"
        middleLocation.text = "Nizhny Novgorod"
